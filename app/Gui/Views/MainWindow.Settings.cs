...
public sealed partial class MainWindow
{
    ...
    UpdateInfo? update;
    bool gameChecked, checkingUpdates;
    ...
    async Task CheckForUpdatesAsync(bool userAsked)
    {
        ...
        if (update is { } u)
            UpdateNotice.Show($"Speak Forever {u.Version.ToString(3)} is available", "Download the new installer from GitHub and run it; it updates this copy in place.", "Download");
        else
